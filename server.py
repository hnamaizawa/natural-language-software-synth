...
class Handler(BaseHTTPRequestHandler):
    server_version = "NaturalLanguageSynth/0.6"
    ...
    def do_GET(self):
        ...
        if parsed.path == "/api/health":
            return self._json({"ok": True, "version": "0.6.0"})
    ...
    def do_POST(self):
        ...
        if parsed.path == "/api/generate-patch":
            ...
            return self._json({"patch": patch.to_dict(), "engine": "offline-deterministic-v0.6"})
...
def main():
    print("Natural Language Software Synth v0.6.0")
