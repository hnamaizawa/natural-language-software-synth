...
(() => {
  ...
  async function previewClip(){
    ...
    arrangementPlaying=true;const queue=sliceQueue(buildPlaybackQueue([{...track,clips:[clip]}]),clip.start_beats,clip.start_beats+clip.length_beats),plannedStart=engine.ctx.currentTime+1.2;
