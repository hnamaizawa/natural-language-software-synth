...
def test_each_track_exposes_and_persists_an_independent_source_selector():
    ...
    assert "/multitrack_runtime.js?v=0.18.2" in html
...
def test_track_vst3_playback_uses_independent_scanned_host_instances():
    ...
    assert "trackNoteOn,trackNoteOff,trackEvents,trackEventsBatch,clearTrackEvents,nextNoteId,baseNoteOn,baseNoteOff" in vst3
